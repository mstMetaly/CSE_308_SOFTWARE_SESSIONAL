...
public class Folder extends FileSystemComponent {
    ...
    public void Details(String name , FileSystemComponent root) {
        if(root.getName().equals(name))
        {
            if(root.getClass().getName().equals("FileSystemLeaf.File")) {
                root.Details(name, root);
            }
            else{
                root.printDetails();
            }
    ...
    public void Makedir(String name)
    {
        ...
        folder.setDirectory(super.getDirectory() + super.getName() + "/");
    ...
    public void Touch(String name , int size)
    {
        ...
        file.setDirectory(super.getDirectory() + super.getName() + "/");
        components.add(file);
